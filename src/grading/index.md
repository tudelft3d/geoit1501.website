...
1. a **group grade** for the project final report and/or the deliverables (see [Rubric group report](./report.md));
1. your **individual performance**, which includes an individual reflection (based on a written reflection at the midterm and a 10-minute personal interview at the end, see below). The individual reflection (see [Rubric reflection](./reflection.md)) can influence positively or negatively for 0.5 grade point (maximum) your overall grade for the course. If the different interviews highlight that a student did not contribute to the group's work, the student can also fail the course.
